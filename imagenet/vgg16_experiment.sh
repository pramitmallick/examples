...
#SBATCH --mem=100GB
#SBATCH --output=out.vgg16_4_0.01_p40_backprop.%j
...
echo "vgg16_4_0.01_p40_backprop"
nvprof --timeout 100 --csv --profile-from-start off --print-summary python subsectionMain.py --arch vgg16 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
