...
#SBATCH --mem=100GB
#SBATCH --output=out.vgg16_8_0.01_p40_full.%j
...
echo "vgg16_8_0.01_p40_full"
nvprof --timeout 300 --output-profile vgg16_8_0.01_p40_full_%p.nvvp --csv --print-summary python main.py --arch vgg16 -b 8 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
