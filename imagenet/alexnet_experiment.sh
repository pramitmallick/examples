...
#SBATCH --mem=100GB
#SBATCH --output=out.alexnet_32_0.01_k80_backprop.%j
...
echo "alexnet_32_0.01_k80_full_backprop"
nvprof --timeout 600 --csv --profile-from-start off --print-summary python subsectionMain.py --arch alexnet -b 32 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
