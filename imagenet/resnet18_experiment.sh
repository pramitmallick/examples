...
#SBATCH --verbose
#SBATCH --job-name=BRexpCloudML
#SBATCH --mem=100GB
#SBATCH --output=out.resnet18_64_0.01_p40_backprop.%j
...
echo "resnet18_64_0.01_p40_backprop"
nvprof --timeout 600 --csv --profile-from-start off --print-summary python subsectionMain.py --arch resnet18 -b 64 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
...
# nvprof --timeout 300 --output-profile resnet18_4_0.01_p40_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch resnet18 -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
