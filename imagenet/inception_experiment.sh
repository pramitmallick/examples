...
nvprof --timeout 100 --output-profile inception_16_0.01_k80_full_%p.nvvp --csv --print-summary python main.py --arch inception -b 16 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
