...
#SBATCH --mem=100GB
#SBATCH --output=out.inception_4_0.01_k80_full_mem.%j
...
echo "inception_4_0.01_k80_full_mem"
...
nvprof --timeout 300 --output-profile inception_4_0.01_k80_full_%p_mem.nvvp --csv --track-memory-allocations on --print-summary python main.py --arch inception -b 4 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
