...
#SBATCH --mem=100GB
#SBATCH --output=out.inception_16_0.01_k80_full.%j
...
echo "inception_16_0.01_k80_full"
...
# nvprof --timeout 200 --kernels "convolve" --metrics gld_efficiency --csv --print-summary python main.py --arch inception -b 16 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
# nvprof --timeout 200 --csv --track-memory-allocations on --print-summary python main.py --arch inception -b 16 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
