...
nvprof --timeout 3000 --output-profile alexnet_64_0.001_small_%p.nvvp --print-summary --csv python main.py --arch alexnet -b 64 --epochs 1 --lr 0.001 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
