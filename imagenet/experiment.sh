...
nvprof --output-profile alexnet_8_0.01_%p --print-summary --csv python main.py --arch alexnet -b 8 --epochs 1 --lr 0.01 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
