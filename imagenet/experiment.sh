...
nvprof --output-profile alexnet_16_0.005_%p --print-summary --csv python main.py --arch alexnet -b 16 --epochs 1 --lr 0.005 /beegfs/work/courses/2019-CSCI-GA-3033-025/imagenet_pytorch_small
